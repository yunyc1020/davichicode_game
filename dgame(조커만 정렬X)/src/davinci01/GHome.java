...
public class GHome extends JFrame{
	...
	/*카드 버튼*/
	ImageIcon w_one = new ImageIcon(Main.class.getResource("../image/white_one.png"));
	ImageIcon b_one = new ImageIcon(Main.class.getResource("../image/검타1.png"));
	ImageIcon b_two = new ImageIcon(Main.class.getResource("../image/검타2.png"));
	ImageIcon b_three = new ImageIcon(Main.class.getResource("../image/검타3.png"));
	ImageIcon b_four = new ImageIcon(Main.class.getResource("../image/검타4.png"));
	ImageIcon b_five = new ImageIcon(Main.class.getResource("../image/검타5.png"));
	ImageIcon b_six = new ImageIcon(Main.class.getResource("../image/검타6.png"));
	ImageIcon b_seven = new ImageIcon(Main.class.getResource("../image/검타7.png"));
	ImageIcon b_eight = new ImageIcon(Main.class.getResource("../image/검타8.png"));
	ImageIcon b_nine = new ImageIcon(Main.class.getResource("../image/검타9.png"));
	ImageIcon b_ten = new ImageIcon(Main.class.getResource("../image/검타10.png"));
	ImageIcon b_eleven = new ImageIcon(Main.class.getResource("../image/검타11.png"));
